...
window.addEventListener("scroll",()=>{
  if (scrollY > 300) {
    btn_up.classList.add("showUp")
  } else {
        btn_up.classList.remove("showUp");
...
const dataProduct =
  ...
  //   // Do something with data, e.g., store in a Sheet
  ...
  // }
const scriptURL =
  "https://script.google.com/macros/s/AKfycbx-EiYOtNEJ11lk1LBohZRCPoIPn45ASTiem7CzpmXipIZGjA660b1ofFHw53lKieJK1g/exec";
